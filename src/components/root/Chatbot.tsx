...
export function DSAChatbotModal({ isOpen, onClose }: ChatbotModalProps) {
  ...
  const {
    ...
    onError: (error) => {
      ...
      try {
        // Try to parse the error message as JSON (for new unified format)
        ...
        if (errorContent.success === false && errorContent.error) {
          errorMessage =
            ...
            errorMessage;
          // For API key errors, provide helpful message
          if (
            ...
            errorMessage =
              "Please set up your API keys in settings to use the chatbot.";
          }
      ...
      suggestions: [
        {
          ...
          prompt:
            "Please review my code for correctness, potential bugs, and suggest improvements.",
          needsCode: true,
        },
        {
          text: "Analyze the time and space complexity of my algorithm",
          prompt:
            "Analyze the time and space complexity of my algorithm and explain the Big O notation.",
          needsCode: true,
        },
        {
          text: "Help me debug this code and find logical errors",
          prompt:
            "Help me debug this code. Are there any logical errors or edge cases I'm missing?",
          needsCode: true,
        },
        {
          text: "Suggest optimizations to improve performance",
          prompt:
            "How can I optimize this algorithm for better performance? Suggest alternatives with better complexity.",
          needsCode: true,
        },
      ],
    },
      ...
      suggestions: [
        {
          ...
          prompt:
            "Explain binary search algorithm step by step with code examples and complexity analysis.",
        },
        {
          text: "Arrays vs Linked Lists comparison",
          prompt:
            "Explain the differences between arrays and linked lists, including their use cases and trade-offs.",
        },
        {
          text: "Dynamic Programming fundamentals",
          prompt:
            "Teach me dynamic programming concepts with simple examples and when to use this approach.",
        },
        {
          text: "Graph traversal algorithms",
          prompt:
            "Explain BFS and DFS graph traversal algorithms with implementations and use cases.",
        },
      ],
    },
    {
      ...
      suggestions: [
        {
          ...
          prompt:
            "Help me break down this complex problem into smaller, manageable parts with a step-by-step approach.",
        },
        {
          text: "Choose the right algorithm for my problem",
          prompt:
            "I need help choosing the right algorithm and data structure for my problem. Can you suggest the best approach?",
        },
        {
          text: "Guide me through two-pointer problems",
          prompt:
            "Explain the two-pointer technique and guide me through solving a problem using this approach.",
        },
        {
          text: "Help with sliding window algorithms",
          prompt:
            "Explain the sliding window technique and help me implement a solution using this pattern.",
        },
      ],
    },
    {
      ...
      suggestions: [
        {
          ...
          prompt:
            "Give me a medium-difficulty array problem to practice with hints and solution approach.",
        },
        {
          text: "Interview questions for my skill level",
          prompt:
            "Suggest some coding interview questions appropriate for my skill level with detailed explanations.",
        },
        {
          text: "Technical interview preparation guide",
          prompt:
            "What are the most important algorithms and data structures I should know for coding interviews?",
        },
        {
          text: "Competitive programming study plan",
          prompt:
            "Help me create a structured study plan for improving my competitive programming skills.",
        },
      ],
    },
  ];
  ...
  const checkScrollPosition = useCallback(() => {
    ...
    setShowScrollButton(
      !nearBottom && scrollHeight > clientHeight && messages.length > 1,
    );
  }, [messages.length]);
  ...
  const currentTabSuggestions =
    suggestionTabs.find((tab) => tab.id === activeTab)?.suggestions || [];
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="text-center py-8 px-4">
                  ...
                  <p className="text-muted-foreground">
                    Choose a category below or ask me anything about algorithms,
          ...
          <form onSubmit={handleFormSubmit} className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-between mt-2">
              <div className="text-xs text-muted-foreground">
                ...
                to send,
                <kbd className="px-1 py-0.5 bg-muted rounded text-xs font-mono ml-1">
                  Shift+Enter
                </kbd>{" "}
                for new line
              </div>
